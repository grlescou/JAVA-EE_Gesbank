...
public class CompteEpargneFacadeREST extends AbstractFacade<CompteEpargne> {
    ...
    public void create(CompteEpargne entity) {
        super.create(entity);
    }
    ...
    @Path("{id}")
    @Consumes({"application/xml", "application/json"})
    public void edit(@PathParam("id") Long id, CompteEpargne entity) {
        super.edit(entity);
    }
    ...
    public CompteEpargne find(@PathParam("id") Long id) {
    ...
    @Path("{from}/{to}")
    @Produces({"application/xml", "application/json"})
    public List<CompteEpargne> findRange(@PathParam("from") Integer from, @PathParam("to") Integer to) {
